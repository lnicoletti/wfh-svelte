...
<div class="legendContainer"> <!-- width={100} height={100} display=flex justify-content=center-->
    <svg width={100} height={100} display=block margin=auto transform="translate({innerWidth>850?innerWidth*0.3:0},{innerWidth>850?0:-50})"> <!-- transform="translate({innerWidth/2-50},{0})" -->
