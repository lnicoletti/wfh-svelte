...
<div class="legendContainer"> <!-- width={100} height={100} display=flex justify-content=center-->
    <svg width={100} height={100} display=block margin=auto transform="translate({innerWidth>innerHeight&&country==="UK"?innerWidth*0.3:0},{innerWidth<innerHeight&&country==="UK"?-80:innerWidth<innerHeight&&country==="US"?-20:0})"> <!--transform="translate({innerWidth/2-50},{0})" -->
