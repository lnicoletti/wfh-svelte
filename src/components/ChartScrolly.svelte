<script>
  ...
  //   let countryOptions = [
    ...
    const k = 63/n
        ...
        const steps = country==="UK"?
                      ["<p>Comprising England, Scotland, Wales, and Northern Ireland, the UK is home to about 67.2 million residents across 374 local authorities.  Each UK  local authority is represented by a single circle in the following cartogram.</p>", 
                       
                      "<p>While considered a high income country by the World Bank, some areas of this sovereign state are home to residents that earn higher income than others.  In the following cartogram, each circle's color tone represents the median household income of that local authority.  Local authorities colored in <span style='background-color:#00441b;font-weight:500;color:#fafafa'>dark green</span> represent areas where residents are higher income, and local authorities colored in <span style='background-color:#73c378;font-weight:500;color:#fafafa'>light green</span> represent areas where residents are low income.</p>",
                       
                      "<p>This same cartogram approach can also be used to investigate the impact of COVID-19 on mobility patterns to the workplace.  While some UK residents have been able to earn a living from home as a result of WFH policies and the pandemic, many people must still travel to work in order to earn an income.  Local authorities colored in <span style='background-color:#7f2704;font-weight:500;color:#fafafa'>dark orange</span> represent areas where residents were unable to benefit from WFH, and they have continued to commute to the workplace.  Local authorities colored in <span style='background-color:#fb8d3d;font-weight:500;color:#fafafa'>light orange</span> represent areas where residents have benefited from WFH policies (i.e., these residents were able to greatly reduce their mobility to the workplace during the pandemic).</p>", 
                       
                      "<p>In considering both household income and mobility patterns to the workplace, insight can be generated into who benefits from WFH in the pandemic era.  The resulting color scheme of such investigation is twofold.  Each of the cartogram circles' color tone is dependent on both 1) the median household income of the local authorities's residents and 2) the residents' percent change in mobility to workplaces relative to a pre-pandemic 2019 baseline.", 
                       
                      "<p>For example, take <span style='background-color:#449d57;font-weight:500;color:#fafafa'>Islington</span> (England).  This local authority is observed to be home to high income residents with a median household income of about £53k.  In general, these residents were able to reduce their mobility to the workplace during the pandemic by 60% when compared to the 2019 baseline.  These residents have benefited from WFH policies.</p>", 
                      ...
                      "<p>Consider the local authority of the <span style='background-color:#449d57;font-weight:500;color:#fafafa'>City of London</span>.  Here, with a median household income of about £65k, residents are categorized as high income.  Since February 2020, these residents were able to reduce their travel to the place by about 55% relative to the pre-pandemic 2019 baseline.</p>", 
                      ...
                      "<p>Despite outliers like Glasgow and East Hampshire, a disproportionate amount of UK local authorities fall into one of two extremes.  Local authority residents are either 1) <span style='background-color:#449d57;font-weight:500;color:#fafafa'>high income and they have benefited greatly from WFH policies</span>, or they are 2) <span style='background-color:#c17036;font-weight:500;color:#fafafa'>low income and they have not benefited greatly from WFH policies</span>.<br><br>As can be observed in the following figure, the “Low Income, High Travel” and “High Income, Low Travel” bins encompass the most local authorities when compared to the other income/mobility categories.</p>", 
                       
                      "<p>Diving deeper into our understanding of who benefits from WFH policies in the UK, local authorities were then also categorized by their urban and rural statuses.  In the UK, a majority of <span style='background-color:#c17036;font-weight:500;color:#fafafa'>Low Income, High Travel</span> local authorities and <span style='background-color:#449d57;font-weight:500;color:#fafafa'>High Income, Low Travel</span> local authorities are found in urban settings.  But are some urban areas in the UK home to more high income residents who benefit from WFH?", 
                       
                      "<p>As it turns out, an overwhelming majority of <span style='background-color:#449d57;font-weight:500;color:#fafafa'>High Income, Low Travel</span> local authorities are located in London's Larger Urban Zone.  <i>What exactly does this mean?</i></p>", 
                       
                      "<p>Relevant to household income and WFH benefits, clear social and spatial segregation exists in the UK.  A strong correlation is present where wealthier residents benefit more than low income residents from WFH policies in response to the COVID-19 pandemic. What's more? These wealthier residents overwhelmingly reside in London's Larger Urban Zone.  Has the UK championed its financial center, London, to the dismay of everywhere else in the kingdom?</p>",
                       
                      "<p>The evidence seems stark to us.  But explore the data and decide for yourself.</p>"]:
                      ...
                      ["<p>With regard to the US, we learned that about 330 million residents dispersed over 3,174 counties call the nation home.  Here, with a cartogram approach, each of these counties are illustrated with a circle.</p>", 
                       ...
                       "<p>Of course, of these 330 million US residents, some are wealthier than others.  The median household income of each county can be observed in the following figure.  While each county is represented by a circle in the cartogram, the median household income of residents in that county is represented by the circle's color tone.  Counties colored in <span style='background-color:#00441b;font-weight:500;color:#fafafa'>dark green</span> represent areas where residents are higher income.  Counties colored in <span style='background-color:#73c378;font-weight:500;color:#fafafa'>light green</span> represent areas where residents are low income.</p>",

                       "<p>This same cartogram approach can also be used to investigate the impact of COVID-19 on US mobility patterns to the workplace.  While employer implemented WFH policies during the COVID-19 pandemic have allowed some US residents to earn a living from home, many people must still commute to the workplace, despite the public health risk, in search of income.  As illustrated below, counties colored in <span style='background-color:#7f2704;font-weight:500;color:#fafafa'>dark orange</span> represent areas where residents have benefited from WFH policies (i.e., these residents were able to greatly reduce their mobility to the workplace during the pandemic).  Contrastingly, counties colored in <span style='background-color:#fb8d3d;font-weight:500;color:#fafafa'>light orange</span> represent areas where residents were unable to benefit from WFH, and they have continued to commute to the workplace.</p>", 
                       ...
                       "<p>Take <span style='background-color:#449d57;font-weight:500;color:#fafafa'>San Francisco County</span> (California).  Here, with a median household income of about $105k, residents are categorized as high income.  Since February 2020, these residents were able to reduce their travel to the place by about 61% relative to the pre-pandemic 2019 baseline.</p>", 
                       ...
                       "<p>Despite outliers like Lafayette County (Arkansas) and Nantucket County (Massachusetts), a disproportionate number of US counties falls into one of two extremes.  County residents are either 1) <span style='background-color:#449d57;font-weight:500;color:#fafafa'>high income and they have benefited greatly from WFH policies</span>, or they are 2) <span style='background-color:#c17036;font-weight:500;color:#fafafa'>low income and they have not benefited greatly from WFH policies</span>.<br><br>As observed in the following figure, the “Low Income, High Travel” and “High Income, Low Travel” bins encompass the most US counties when compared to the other income/mobility categories.</p>", 

                       "<p>Diving deeper into our understanding of <i>who</i> benefits from WFH policies in the US, counties were then categorized by their urban and rural statuses.<br><br>Shockingly, in the US, a majority of <span style='background-color:#c17036;font-weight:500;color:#fafafa'>Low Income, High Travel</span> counties are found in rural settings. In contrast, an overwhelming number of <span style='background-color:#449d57;font-weight:500;color:#fafafa'>High Income, Low Travel</span> counties are categorized as urban areas.  A clear divide exists.  Residents of urban US counties are more likely to be earning higher median household incomes and benefiting from WFH policies when compared to their rural counterparts.</p>", 
...
<div class="chartElements">
  ...
  <svg viewBox="0 0 800 600" bind:this={svg} class="mainChart">
